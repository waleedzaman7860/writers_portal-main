...
<body>
      ...
      <div class="card" style="width:360px; margin-left: 120px; background-color: whitesmoke; color:black;">

        <div class="card-body" style="width:560px; margin-left: 250px; background-color: whitesmoke; color:black;">
          <h4 class="card-title"></h4>
          <p class="card-text">Some example text.</p>
          <a href="{{$actionLink}}" class="btn btn-primary">See Profile</a>
...
<body bgcolor="#E1E1E1" leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
                            ...
                            <table border="0" cellpadding="30" cellspacing="0" width="100%">
                              <tr>
                                <td align="center" valign="top" class="textContent">
                                  ...
                                  <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;"> has been completed. {!!$body!!}
                                  </div>
                                </td>
                              </tr>
                            </table>
                                  ...
                                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                      <td valign="top" class="textContent">
                                        ...
                                        <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">Your new email is:<b> {{ $email}} </b></div>
                                        <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">Your new password is:<b> {{ $password}}</b></div>
                                  ...
                                  <table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #2E7D32;">
                                    <tr>
                                      <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                                        <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" id="verifyButton" href="{{$actionLink}}" @if ($expiration) disabled @endif target="_blank">Verify</a>
                                      </td>
                                    </tr>
                                  </table>
  ...
  <script>
    ...
    var expiration = {!! json_encode($expiration) !!}; // Convert PHP boolean to JavaScript boolean
    if (expiration) {
